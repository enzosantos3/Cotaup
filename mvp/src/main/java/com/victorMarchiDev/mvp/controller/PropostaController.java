...
public class PropostaController {
    ...
    public ResponseEntity<List<CotacaoProdutoModel>> listarProdutosPorProposta(@PathVariable("id") Long id) {
        List<CotacaoProdutoModel> produtos = propostaService.listarProdutosPorPropostas(id);
